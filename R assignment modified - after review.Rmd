...
sample_prop <- ggplot(mutate_f_samples, aes(x = Sample_ID, y = n, fill = substitution)) +
  ...
  labs(title = "Proportion of Homozygotes, Heterozygotes and Missing Data in Samples",
       x = "Sample_ID",
       y = "Proportion",
       fill = "substitution") +
...
group_prop <- ggplot(mutate_f_groups, aes(x = Group, y = n, fill = substitution)) +
  geom_bar(stat = "identity", position = "fill") +
  labs(title = "Proportion of Homozygotes, Heterozygotes and Missing Data in Groups",
       x = "Group",
       y = "Proportion",
       fill = "substitution") +
